	...
	<div id="title">
		<div class="row">
			...
			<div id="userInfo" class="col-md-3">
				...
				<a data-toggle="tooltip" title="6个工作事项" class="top-block" href="#" onclick="loadPage('./work.jsp');">
	...
	<nav class="navbar navbar-default" role="navigation">
		<div class="container-fluid" style="background-color: #bd0625e6;"> 
		    <div class="navbar-header">
		        ...
		        <a class="navbar-brand" href="#" onclick="loadPage('<%=path%>/page/detailListManager.jsp');">清单管理</a>
		        <a class="navbar-brand" href="#" onclick="loadPage('<%=path%>/page/workManager.jsp');">工作管理</a>
