		   ...
		   <div class="row">
				<div class="col-md-12">
					<div class="col-md-4">
						...
						<div class="col-md-8">
							<input class="form-control" id="labelName" type="text" value="${labelName}">
						</div>
					</div>
					<div class="col-md-4">
			                 ...
			                 <tbody>
			                 	<c:forEach items="${label}" var="label">
			                 		<tr>
					                     ...
					                     <td class="center">
					                         <a class="btn btn-info" href="#" onclick="editDetailList('${label.id}');">
					                             <i class="glyphicon glyphicon-edit icon-white"></i>
					                             	编辑
					                         </a>
					                         <a class="btn btn-danger" href="#" onclick="delDetailList('${label.id}');">
